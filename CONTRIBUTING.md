# Contributing to vega-spatialdata

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
vega-spatialdata. These guidelines are not strict rules.
...
The vega-spatialdata team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the vega-spatialdata technical leads
...
[issues]: https://github.com/scverse/vega-spatialdata/issues/
[pulls]: https://github.com/scverse/vega-spatialdata/pulls/
